...
interface NicheSelectionProps {
  ...
  onNicheSelected: (nicheId: string) => void;
}

const NicheSelection: React.FC<NicheSelectionProps> = ({ selectedNiche, onNicheSelected }) => {
  ...
  const renderNicheItem = ({ item }: { item: Niche }) => {
